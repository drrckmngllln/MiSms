        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Manage Campuses</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Campuses</a></li>
                                <li class="breadcrumb-item active">All Campused</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    @include('Roles.Super_Administrator.campus.create')
                    ...
                    @include('Roles.Super_Administrator.campus.edit')
                </div>
            </div>
