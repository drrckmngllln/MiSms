...
<div class="modal fade bs-example-modal-xl" tabindex="-1" id="editLabFee" role="dialog"
...
@push('scripts')
    <script>
        function editLaboratoryFee(id, category, description, campus_id, first_year, second_year, third_year, fourth_year,
            semester, course_id) {
            // console.log(id);
            $('#edit_id').val(id);
