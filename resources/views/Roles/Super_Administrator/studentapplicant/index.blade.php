...
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card" style="margin-top: 20px;">
                        <div class="card-body">
                            <h4 class="card-title">Online Students Applicants</h4>
                            {{ $dataTable->table() }}
                        </div>
    ...
    <!-- End Page-content -->
@endsection
@include('Roles.Super_Administrator.studentapplicant.create')
...
@include('Roles.Super_Administrator.studentapplicant.assesment')
